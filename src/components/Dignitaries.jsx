...
const dignitaries = [
  {
    ...
    org: 'District Governor 2027-28 / DRCC',
    initials: 'AN',
...
function Avatar({ initials, image, imgStyle, size = 112 }) {
  ...
  return (
    <div className="relative mx-auto" style={{ width: outerSize, height: outerSize }}>
      ...
      >
        {image ? (
          <img src={image} alt="Avatar" className="w-full h-full object-cover" style={imgStyle} />
        ) : (
          <span
