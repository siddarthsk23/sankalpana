...
const featured = [
  {
    name: 'DRR Rtn. Rtr. Amey Mangesh Varerkar',
    designation: 'District Rotaract Representative 2026-27',
    org: 'Rotaract District 3170',
    initials: 'AV',
    image: '/images/amey_nobg.png',
  },
  {
    name: 'Rtn. Lenny D’Costa',
    designation: 'Chief Guest and Installing Officer',
    org: 'District Governor 2026-27',
    initials: 'LD',
    image: '/images/lenny.png',
...
const dignitaries = [
  ...
  {
    name: 'Rtn. Nester Sequiera',
    designation: 'DRCC - 2026-27',
    org: '',
    initials: 'NS',
  ...
  },
  {
    ...
    org: '',
    initials: 'NC',
    image: '/images/nikhil_nobg.png',
  },
  {
    name: 'Rtr. Minar Kanekar',
    designation: 'District Secretary Administration',
    org: '',
    initials: 'MK',
    image: '/images/minar_nobg.png',
  },
  {
    name: 'Rtr. Chaitanya Nilkanthanawar',
    designation: 'District Secretary Reporting',
    org: '',
    initials: 'CN',
    image: '/images/chaitanya_nobg.png',
  },
  {
    name: 'Rtr. Sanjali Nagvenkar',
    designation: 'District Secretary Events',
    org: '',
    initials: 'SN',
    image: '/images/sanjali_nobg.png',
  },
];
...
/* ── single card ── */
function DignitaryCard({ data, index, isFeatured = false, className = '' }) {
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div ref={sectionRef} className="text-center mb-20">
          <motion.p
            className="text-xs md:text-sm font-semibold uppercase tracking-[0.3em] text-brand-purple-500/60 mb-4"
        ...
        {/* featured cards */}
        <div className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          {featured.map((d, i) => (
            <DignitaryCard key={d.name} data={d} index={i} isFeatured />
          ))}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 md:gap-8 mb-6 md:mb-8">
          {dignitaries.map((d, i) => (
            <DignitaryCard
              key={d.name}
              data={d}
              ...
              className={`md:col-span-2 ${
                dignitaries.length === 5 && i === 3 ? 'md:col-start-2' : ''
              }`}
            />
          ))}
        </div>
