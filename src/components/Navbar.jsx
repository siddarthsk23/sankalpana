      ...
      >
        ...
        >
          <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-18 relative">
            ...
            {/* Right: Partner Logos */}
            <div className="flex items-center justify-end flex-shrink-0 mr-4 lg:mr-0">
              <img
                src="/images/logos_strip.png"
                alt="Partner Logos"
                className="h-5 sm:h-7 md:h-10 lg:h-10 xl:h-12 w-auto object-contain transition-transform hover:scale-105 duration-300"
              />
            </div>
